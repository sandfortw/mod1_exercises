RSpec.describe 'reject pattern' do
  ...
  it 'removes numbers divisible by 3' do
    ...
    remaining = []
    numbers.each {|number| remaining << number unless number % 3 == 0}
  ...
  it 'removes words ending in e' do
    ...
    # Your code goes here
    selected = []
    words.each {|word| selected << word unless word.end_with?('e')}
  ...
  it 'removes words ending in ing' do
    ...
    # Your code goes here
    selected = []
    words.each {|word| selected << word unless word.end_with?("ing")}
  ...
  it 'removes numbers' do
    ...
    # Your code goes here
    not_numbers = []
    elements.each {|element| not_numbers << element unless element.to_s.match(/[1234567890]/)}
  ...
  it 'removes floats' do
    ...
    # Your code goes here
    not_numbers = []
    elements.each {|element| not_numbers << element unless element.to_s.include?(".")}
  ...
  it 'removes animals starting with vowels' do
    ...
    # Your code goes here
    remaining = []
    animals.each {|animal| remaining << animal unless animal.start_with?(/[aeiouy]/)}
  ...
  it 'removes arrays' do
    ...
    # Your code goes here
    remaining = []
    elements.each {|element| remaining << element unless element.kind_of?(Array)}
  ...
  it 'removes hashes' do
    ...
    remaining = []
    elements.each {|element| remaining << element unless element.kind_of?(Hash)}
