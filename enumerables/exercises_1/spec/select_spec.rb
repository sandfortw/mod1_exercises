RSpec.describe 'select' do
  ...
  it 'words ending in ing' do
    ...
    # Your code goes here
    selected = words.select do |word|
      word.end_with?("ing") == true ? word : nil
    end
  ...
  it 'dinosaurs' do
    ...
    dinosaurs = animals.select do |animal|
      animal.include?("saurus") == true ? animal : nil
    end
  ...
  it 'arrays' do
    ...
    arrays = elements.select do |element|
      element.kind_of?(Array) ? element : nil
    end
