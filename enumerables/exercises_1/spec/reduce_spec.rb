RSpec.describe 'reduce' do
  ...
  it 'capitalize key words in phrase' do #THIS CODE IS TERRIBLE, FIX LATER#
    keywords = ["fish", "blue"]
    # initial value is 'one fish two fish red fish blue fish'
    # Your code goes here
    result = keywords.reduce('one fish two fish red fish blue fish') do |initial, word|
      initial.gsub(word, word.upcase)
    end
  ...
  it 'divides 560 by a bunch of numbers' do
    ...
    # Your code goes here
    result = numbers.reduce(560) do |initial, number|
      initial / number
    end
  ...
  it 'subtract smallest values from 100' do
    ...
    result = elements.reduce(100) do |initial, element|
      initial - element.sort[0]
    end
  ...
  it 'adds all second values together' do
    ...
    # initial value is 0
    # Your code goes here
    result = elements.reduce(0) do |initial, element|
      initial + element[1]
    end
